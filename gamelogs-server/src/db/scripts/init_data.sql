INSERT INTO gl_user (user_id, user_name, user_biography, user_pfp_uri, num_reviews, num_followers, num_following) VALUES
    (1, 'sample user1', 'this is a sample user description. i can write whatever i want', NULL, 1, 0, 5),
...
INSERT INTO review (review_id, user_id, game_id, rating, review_description, review_date) VALUES
    ...
    (3, 9922, 114465, 5, 'fruit ninja in VR, how technology progresses...', TIMESTAMP '2024-11-14 19:15:00'),
    ...
    (6, 1328, 275018, 1, 'sample review', TIMESTAMP '2024-11-16 18:00:00'),
